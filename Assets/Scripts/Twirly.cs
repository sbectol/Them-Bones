    ...
    void Start()
    {
        ...
        switch (animationToPlay) {
            ...
            case "6":
                ...
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>Since I left you I found they have discovered two large Tusks of Tygers at Plymouth and passing through Wells I heard tidings of human bones at Wokey(sic) Hole...";
                storyText.text += "\n";
            ...
            case "8":
                ...
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>‘an unknown carnivorous animal, at least as large as a tiger; the genus of which has not yet ! been determined.’</i></indent>";
                storyText.text += "\n";
                ...
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>‘The Branch of the Cavern termed the Wolf’s Den by MacEnery, and in which he found the celebrated five fine canines of Machairodus is immediately on the right, or north, of our present! work but we still have to state that we have met with no trace of that huge Cave mammal.’</i></indent>";
                storyText.text += "\n";
                storyText.text += "And then later that year;";
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>We commenced the exploration of the Wolf’s Den on July the 12th 1871, and from time to time ! we cherished hope that we might, like MacEnery, find in it some traces of Machairodus.</i></indent>";
                storyText.text += "\n";
                ...
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>No. 5962. In Cave-Earth, 4th parallel, 1st Level, 1 yard right, including 1 tooth in left lower jaw of Bear and 1 of Machairodus.</i></indent>";
                storyText.text += "\n";
            ...
            case "9":
                ...
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>‘when Mr Dawkins was chatting with my friend and me, the men laid bare a small escarpment, when we saw a canine, which Mr Dawkins immediately recognised and exclaimed “Hurrah! The! Machairodus!”</i></indent>";
                storyText.text += "\n";
                storyText.text += "Heath’s later testimony, also attributed to the workman Moses Hartley, extends Dawkins’ exclamation adding;";
                storyText.text += "\n";
                storyText.text += "<indent=15%><i>“Oh my! Pengelly will go wild when he hears of this! It will spread like wildfire over Europe!”</i></indent>";
                storyText.text += "\n";
